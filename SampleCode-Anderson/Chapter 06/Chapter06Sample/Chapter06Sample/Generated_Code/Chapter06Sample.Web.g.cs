...
namespace Chapter06Sample.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("Chapter06Sample-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Chapter06Sample.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("Chapter06Sample-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
...
namespace Chapter06Sample.Web.Models
{
    ...
    /// <summary>
    /// The 'ProductSummary' entity class.
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Chapter06Sample.Web.Models")]
    public sealed partial class ProductSummary : Entity
    {
        ...
        private Nullable<int> _quantityAvailable;
        ...
        partial void OnQuantityAvailableChanging(Nullable<int> value);
        ...
        /// <summary>
        /// Gets or sets the 'QuantityAvailable' value.
        /// </summary>
        [DataMember()]
        public Nullable<int> QuantityAvailable
        {
            get
            {
            ...
            set
            {
                if ((this._quantityAvailable != value))
                {
                    ...
                    this.RaiseDataMemberChanging("QuantityAvailable");
                    this.ValidateProperty("QuantityAvailable", value);
                    this._quantityAvailable = value;
                    this.RaiseDataMemberChanged("QuantityAvailable");
        ...
        public string Subcategory
        {
            ...
            set
            {
                if ((this._subcategory != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Subcategory");
                    this.ValidateProperty("Subcategory", value);
                    this._subcategory = value;
                    this.RaiseDataMemberChanged("Subcategory");
...
namespace Chapter06Sample.Web.Services
{
    ...
    public sealed partial class ProductsContext : DomainContext
    {
        ...
        public ProductsContext() : 
                this(new WebDomainClient<IProductsServiceContract>(new Uri("Chapter06Sample-Web-Services-ProductsService.svc", UriKind.Relative)))
        {
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="ProductSummary"/> entities that have been loaded into this <see cref="ProductsContext"/> instance.
        /// </summary>
        public EntitySet<ProductSummary> ProductSummaries
        {
            get
            {
                return base.EntityContainer.GetEntitySet<ProductSummary>();
            }
        }
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="ProductSummary"/> entities using the 'GetProductSummaryList' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="ProductSummary"/> entities.</returns>
        public EntityQuery<ProductSummary> GetProductSummaryListQuery()
        {
            this.ValidateMethod("GetProductSummaryListQuery", null);
            return base.CreateQuery<ProductSummary>("GetProductSummaryList", null, false, true);
        }
        ...
        public interface IProductsServiceContract
        {
            ...
            /// <summary>
            /// Asynchronously invokes the 'GetProductSummaryList' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ProductsService/GetProductSummaryListDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/ProductsService/GetProductSummaryList", ReplyAction="http://tempuri.org/ProductsService/GetProductSummaryListResponse")]
            [WebGet()]
            IAsyncResult BeginGetProductSummaryList(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetProductSummaryList'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetProductSummaryList'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetProductSummaryList' operation.</returns>
            QueryResult<ProductSummary> EndGetProductSummaryList(IAsyncResult result);
        ...
        internal sealed class ProductsContextEntityContainer : EntityContainer
        {
            ...
            {
                this.CreateEntitySet<ProductSummary>(EntitySetOperations.None);
