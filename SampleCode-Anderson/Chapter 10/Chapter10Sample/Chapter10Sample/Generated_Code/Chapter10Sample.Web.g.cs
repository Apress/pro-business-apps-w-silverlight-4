...
namespace Chapter10Sample.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("Chapter10Sample-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Chapter10Sample.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("Chapter10Sample-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
...
namespace Chapter10Sample.Web.Services
{
    ...
    public sealed partial class ProductContext : DomainContext
    {
        ...
        public ProductContext() : 
                this(new WebDomainClient<IProductServiceContract>(new Uri("Chapter10Sample-Web-Services-ProductService.svc", UriKind.Relative)))
        {
        }
