...
namespace Chapter12Sample.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("Chapter12Sample-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Chapter12Sample.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("Chapter12Sample-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
...
namespace Chapter12Sample.Web.Services
{
    ...
    /// <summary>
    /// The domain context corresponding to the 'ProductService' domain service.
    /// </summary>
    public sealed partial class ProductContext : DomainContext
    {
        ...
        public ProductContext() : 
                this(new WebDomainClient<IProductServiceContract>(new Uri("Chapter12Sample-Web-Services-ProductService.svc", UriKind.Relative)))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductContext"/> class with the specified service URI.
        /// </summary>
        /// <param name="serviceUri">The ProductService service URI.</param>
        public ProductContext(Uri serviceUri) : 
                this(new WebDomainClient<IProductServiceContract>(serviceUri))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductContext"/> class with the specified <paramref name="domainClient"/>.
        /// </summary>
        /// <param name="domainClient">The DomainClient instance to use for this domain context.</param>
        public ProductContext(DomainClient domainClient) : 
                base(domainClient)
        {
            this.OnCreated();
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="Product"/> entities that have been loaded into this <see cref="ProductContext"/> instance.
        /// </summary>
        ...
        protected override EntityContainer CreateEntityContainer()
        {
            return new ProductContextEntityContainer();
        }
        
        /// <summary>
        /// Service contract for the 'ProductService' domain service.
        /// </summary>
        [ServiceContract()]
        public interface IProductServiceContract
        {
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ProductService/GetProductDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/ProductService/GetProduct", ReplyAction="http://tempuri.org/ProductService/GetProductResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ProductService/GetProductsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/ProductService/GetProducts", ReplyAction="http://tempuri.org/ProductService/GetProductsResponse")]
            [WebGet()]
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/ProductService/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/ProductService/SubmitChanges", ReplyAction="http://tempuri.org/ProductService/SubmitChangesResponse")]
            IAsyncResult BeginSubmitChanges(IEnumerable<ChangeSetEntry> changeSet, AsyncCallback callback, object asyncState);
        ...
        internal sealed class ProductContextEntityContainer : EntityContainer
        {
            
            public ProductContextEntityContainer()
            {
