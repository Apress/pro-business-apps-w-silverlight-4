...
namespace Chapter05Sample.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("Chapter05Sample-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Chapter05Sample.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("Chapter05Sample-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
...
namespace Chapter05Sample.Web.Models
{
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/Chapter05Sample.Web.Models")]
...
namespace Chapter05Sample.Web.Services
{
    ...
    public sealed partial class ProductPMContext : DomainContext
    {
        ...
        public ProductPMContext() : 
                this(new WebDomainClient<IProductPMServiceContract>(new Uri("Chapter05Sample-Web-Services-ProductPMService.svc", UriKind.Relative)))
        {
        }
    ...
    public sealed partial class ProductsContext : DomainContext
    {
        ...
        public ProductsContext() : 
                this(new WebDomainClient<IProductsServiceContract>(new Uri("Chapter05Sample-Web-Services-ProductsService.svc", UriKind.Relative)))
        {
        }
