namespace AdventureWorksMiddleTier.Web.Resources
{
    using System;
    ...
    internal static class ClientCultureBasedResources
    {
        ...
        ///    'AdventureWorksLOB-culture' cookie (which gets set by the Siverlight ASPX
        ///    wrapper, see AdventureWorksLOBTestPage.aspx). If there is no such
        ...
        private static CultureInfo CurrentCulture
        {
            get
            {
                string clientCulture = HttpContext.Current.Request.Cookies["AdventureWorksLOB-culture"].Value;
