This solution demonstrates implementing a middle tier, using RIA Services Class
Library projects.  You will find an entity model defined in the 
AdventureWorksMiddleTier.Web project, from which the services in the same project
...
- Separating business logic out into a middle tier
